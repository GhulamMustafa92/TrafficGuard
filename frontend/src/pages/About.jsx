...
<div className="w-full max-w-xl space-y-6 -translate-y-8">

              {/* Badge */}
  <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/25 bg-cyan-400/5 px-3 py-1.5 text-[11px] font-mono uppercase tracking-[0.2em] text-cyan-400 backdrop-blur-md">                <span className="relative flex h-2 w-2">
              ...
              {/* Heading */}
              <h2 className="text-2xl font-black uppercase leading-[1.1] tracking-tight sm:text-3xl lg:text-4xl">
              ...
              {/* Description */}
              <p className="border-l-2 border-cyan-400/40 pl-4 text-xs text-gray-300 sm:text-sm">
                ...
                <div className="pr-7">
                  <div className="overflow-hidden rounded-xl border border-white/[0.05] bg-black/20">
                    <img
                      ...
                      className="block w-[480px] rounded-2xl object-contain opacity-90 transition-opacity duration-300 hover:opacity-100"
                    />
                  </div>
                </div>
