          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                {/* BACKGROUND GLOW */}
                <div className="absolute -right-20 -top-20 h-44 w-44 rounded-full bg-cyan-400/[0.025] blur-3xl transition-all duration-700 group-hover:bg-cyan-400/[0.09]" />

                {/* LARGE HOVER ICON */}
                <div className="pointer-events-none absolute right-[-15px] top-[58px] z-0 opacity-0 translate-x-8 rotate-6 transition-all duration-700 ease-out group-hover:translate-x-0 group-hover:rotate-0 group-hover:opacity-[0.12]">
                  <Icon className="text-[150px] text-cyan-300 drop-shadow-[0_0_25px_rgba(34,211,238,0.35)]" />
                </div>

                {/* NUMBER */}
                <span className="absolute right-5 top-5 z-10 font-mono text-[10px] tracking-[0.2em] text-slate-700 transition-all duration-300 group-hover:text-cyan-400/50">
                  {service.number}
                </span>

                {/* ICON */}
                <div className="relative z-10 mb-6 flex h-12 w-12 items-center justify-center rounded-xl border border-cyan-400/15 bg-cyan-400/[0.06] text-cyan-400 shadow-[0_0_20px_rgba(34,211,238,0.06)] transition-all duration-500 group-hover:border-cyan-400/30 group-hover:bg-cyan-400/10 group-hover:shadow-[0_0_25px_rgba(34,211,238,0.15)] group-hover:scale-105">
                  <Icon className="text-lg" />
                </div>

                {/* CONTENT */}
                <div className="relative z-10 w-full sm:max-w-[85%]">
                  <h3 className="text-base font-semibold tracking-wide text-white transition-colors duration-300 group-hover:text-cyan-300">
                    {service.title}
                  </h3>
                ...
                <div className="absolute bottom-6 left-6 right-6 z-10">
                  <div className="flex items-center justify-center sm:justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="h-px w-8 bg-cyan-400/30 transition-all duration-500 group-hover:w-14 group-hover:bg-cyan-400/70" />
                      <span className="font-mono text-[8px] uppercase tracking-[0.15em] text-slate-600 transition-colors duration-300 group-hover:text-cyan-400/70">
                        AI SYSTEM
                      </span>
                    </div>

                    <div className="hidden sm:flex items-center gap-1.5">
                      <span className="h-1.5 w-1.5 rounded-full bg-cyan-400 opacity-50 shadow-[0_0_8px_rgba(34,211,238,0.8)] transition-all duration-300 group-hover:opacity-100" />
                      <span className="font-mono text-[7px] uppercase tracking-widest text-slate-700 transition-colors duration-300 group-hover:text-cyan-400/60">
                        ACTIVE
                      </span>
                    </div>
                ...
                {/* BOTTOM GLOW */}
                <div className="absolute bottom-0 left-1/2 h-px w-0 -translate-x-1/2 bg-gradient-to-r from-transparent via-cyan-400 to-transparent transition-all duration-700 group-hover:w-[75%]" />
              </div>
            );
          })}
        </div>
